...
export default function Footer() {
  ...
  const openWhatsApp = () => {
    ...
    const message =
      "Hello, I would like to book an appointment or get more information about your services.";
  ...
  return (
    <footer className="bg-[#1e3a34] text-gray-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mb-4 leading-relaxed">
            Helping you move better, recover faster, and live pain-free with
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2">
              ...
              <a
                href="mailto:info@advikaclinic.com"
          ...
          <div className="flex gap-4 mt-5">
            ...
            <a
              href="https://www.instagram.com/advikaphysiotherapyclinic?igsh=MWNqZWdhYWd1MmVmeA=="
            ...
            <a
              href="https://www.linkedin.com/in/dr-swati-sharma-pt-a597a81b1/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
              aria-label="LinkedIn"
              className="hover:text-white"
            >
      ...
      <div className="mt-12 border-t border-gray-700 pt-6 text-center text-xs text-gray-500">
        <p>
          © {new Date().getFullYear()} Advika Physiotherapy Clinic. All rights
          reserved. |{" "}
